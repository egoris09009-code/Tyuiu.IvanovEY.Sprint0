using Tyuiu.IvanovEY.Sprint0.Task7.V0.Lib;
class Program
{
    static void Main(string[] args)
    {
        Console.Title = "Спринт #0 | Выполнил: Иванов Е. Ю. | ИСТНб-26-1";
        ...
        Console.WriteLine("* Выполнил: Иванов Егор Юрьевич | ИСТНб-26-1                              *");
        Console.WriteLine("***************************************************************************");
